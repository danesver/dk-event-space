...
<form class="form-signin" action="" method="post">
    <a href="index.php"></a>
    <h5 class="h5 mb-3 font-weight-normal" style="color:#222">Qaca House <br /> Login As Administrator</h5>
    <?php
        if ($session->message()) {
    ...
    <button class="btn btn-md btn-danger btn-block" type="submit" name="login" style="background-color:#1b7261;border-color:#1b7261;">Log In</button>
