...
<main>
               ...
               <div class="row gx-30">
                  <div class="col-xl-7 col-lg-7 col-md-12">
                     <div class="rr-hero-banner">
                        <h6 class="rr-hero-title wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">Welcome to Qaca House</h6>
                        <h2 class="rr-hero-subtitle wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">Where Memories Begin</h2>
                        <p class=" wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">Experience elegance and functionality in a space designed to make your event unforgettable.
                        Whether it's a wedding, corporate gathering, or private celebration,<br /> our venue offers the ideal setting to bring your vision to life<br />
                        Reserve your spot today and let us make your event extraordinary
                        </p>
                        <div class="rr-hero-banner-info d-flex align-items-center ">
                           ...
                           <div class="rr-hero-banner-play d-flex align-items-center wow rrfadeUp"
                              ...
                              <div class="rr-hero-banner-play z-index-2">
                                 <span><a class="popup-video" href="https://www.youtube.com/embed/2IaEAzDgX3s?si=5d6Tv6sjdIxUEMbm"><i
                                          class="fa-sharp fa-regular fa-play"></i></a></span>
                              </div>
                              <div class="rr-hero-banner-text">
                                 <b><a class="popup-video" href="https://www.youtube.com/embed/2IaEAzDgX3s?si=5d6Tv6sjdIxUEMbm">Watch
                                       Video</a></b>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="rr-about-main-info text-center">
                     <div class="rr-about-title-wrapper text-center mb-40">
                        <span class="rr-section-subtitle wow rrfadeUp" data-wow-duration=".9s"
                           data-wow-delay=".3s">About Qaca House</span>
                        <p class=" wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">Qaca House is Kuala Lumpur’s newest event space, offering a perfect blend of modern elegance and versatility in the heart of the city. Designed to host a variety of occasions like weddings, corporate meetings, product launches, private dinners, and more. Our stunning venue features customizable layouts and state-of-the-art facilities to bring your vision to life. With a dedicated team ensuring every detail is seamless, Qaca House is where unforgettable moments are created and cherished.</p>
                     </div>
      ...
      <!--<div class="rr-funfact-area pt-60 pb-100 p-relative fix">
         <div class="container">
            ...
            <div class="rr-funfact">
               <div class="row gx-30">
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 0.9s; animation-delay: 0.3s; animation-name: rrfadeUp;">
                     <div class="rr-funfact-content text-center fix p-relative">
                        <div class="rr-funfact-number d-flex align-items-center justify-content-center">
                           <h5 class="rr-funfact-number purecounter" data-purecounter-duration="0" data-purecounter-end="1200">1200</h5>
                        </div>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".5s" style="visibility: visible; animation-duration: 0.9s; animation-delay: 0.5s; animation-name: rrfadeUp;">
                     <div class="rr-funfact-content text-center fix p-relative">
                        <div class="rr-funfact-number d-flex align-items-center justify-content-center">
                           <h5 class="rr-funfact-number purecounter" data-purecounter-duration="0" data-purecounter-end="1545">1545</h5>
                        </div>
                        <div class="rr-funfact-text">
                           <span>Weddings</span>
                        </div>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".7s" style="visibility: visible; animation-duration: 0.9s; animation-delay: 0.7s; animation-name: rrfadeUp;">
                     <div class="rr-funfact-content text-center fix p-relative">
                        <div class="rr-funfact-number d-flex align-items-center justify-content-center">
                           <h5 class="rr-funfact-number purecounter" data-purecounter-duration="0" data-purecounter-end="750">750</h5>
                           <b>+</b>
                        </div>
                        <div class="rr-funfact-text">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".9s" style="visibility: visible; animation-duration: 0.9s; animation-delay: 0.9s; animation-name: rrfadeUp;">
                     <div class="rr-funfact-content text-center fix p-relative">
                        <div class="rr-funfact-number d-flex align-items-center justify-content-center">
                           <h5 class="rr-funfact-number purecounter" data-purecounter-duration="0" data-purecounter-end="265">265</h5>
                           <b>+</b>
                        </div>
                        <div class="rr-funfact-text">
                           <span>Locations</span>
      ...
      <section class="rr-pricing-area p-relative pt-90 pb-90 fix">
         <div class="container">
            ...
            <div class="row">
            <?php $counter = 0; foreach ($category as $category_row) :?>
               
               <div class="col-lg-4 col-md-6 col-12 p-0">
                  <?php if($counter == 1){?>
                  <div class="rr-pricing-item rr-pricing-item-medial p-relative active mb-30 wow fadeInUp text-center" data-wow-duration="1s" data-wow-delay=".5s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInUp;">
                  <?php }else{?>
                     <div class="rr-pricing-item p-relative mb-30 wow fadeInUp text-center" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                  
                     <?php }?>  
                  <div class="rr-pricing-head">
                        <h4 class="rr-pricing-tag"><?= $category_row->wedding_type; ?></h4>
                     </div>
                     <h3 class="rr-pricing-price">RM <?= number_format($category_row->price); ?><span> /Event</span></h3>
                     <div class="rr-pricing-list">
                        <ul>
                        <?php $feature = DB::table('tbl_features')->where('category_id',$category_row->id)->get(); ?>
                           <?php foreach ($feature as $feature_item) : ?>
                              <li ><?= $feature_item->title; ?></li>
                           <?php endforeach; ?>
               ...
               <div class="col-xl-12">
                  <div class="rr-video-wrap">
                     <div class="rr-video-play">
                        <span><a class="popup-video" href="https://www.youtube.com/embed/2IaEAzDgX3s?si=5d6Tv6sjdIxUEMbm"><svg width="17"
            ...
            <div class="row gx-30">
               <div class="col-xl-4 col-lg-4 col-md-6 col-12 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                  <div class="rr-team-item text-center mb-50">
                     ...
                     <div class="rr-team-content">
                        <h4 class="rr-team-title">Henry D’suza</h4>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-12 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                  <div class="rr-team-item text-center mb-50">
                     ...
                     <div class="rr-team-content">
                        <h4 class="rr-team-title">Robert William</h4>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-12 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                  <div class="rr-team-item text-center mb-50">
                     ...
                     <div class="rr-team-content">
                        <h4 class="rr-team-title">Jenefer Abram</h4>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-12 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                  <div class="rr-team-item text-center mb-50">
                     ...
                     <div class="rr-team-content">
                        <h4 class="rr-team-title">Robert Willy</h4>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-12 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".8s">
                  <div class="rr-team-item text-center mb-50">
                     ...
                     <div class="rr-team-content">
                        <h4 class="rr-team-title">Rodger Garza</h4>
      ...
      <section class="rr-map-area">
       ...
       <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d248.97371353528305!2d101.7021875!3d3.2045852!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc47f78a5369ad%3A0x61ec6e0fc12dcc13!2sQaca%20House%20Event%20Space!5e0!3m2!1sen!2s!4v1745865823502!5m2!1sen!2s" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
